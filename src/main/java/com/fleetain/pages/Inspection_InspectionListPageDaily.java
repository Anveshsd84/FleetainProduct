...
public class Inspection_InspectionListPageDaily extends TestBase {
//*******************************************NEW INSPECTION FORM*************************************
...
//*******************************************Assign Vehicle******************************************
	...
	@FindBy(name="FREQUENCY") WebElement selctFrequency;
...
//*******************************************ADD WORK FLOW******************************************	
	...
	@FindBy(xpath="//input[@type='checkbox' and @name='EMAIL_USER[]' and @value='465']") WebElement emailUseranvwesh;
	@FindBy(xpath = "//input[@type='checkbox' and @name='NOTIFICATION_USER[]' and @value='464']")WebElement notificationKilas;
	@FindBy(xpath = "//input[@type='checkbox' and @name='NOTIFICATION_USER[]' and @value='465']")WebElement notificationanwesh;
	@FindBy(xpath = "//input[@type='checkbox' and @name='NOTIFICATION_USER[]' and @value='466']")WebElement notificatioMayur;
	
//*****************************************************************************************************	
	public Inspection_InspectionListPageDaily() {
...
//    	uploadFile("C:\\Users\\Intel\\Downloads\\cleanveh.jpg");
	...
	public void assignVehicleDetails() throws InterruptedException {
		...
		selvechicle.selectByValue("All Vehicles");
		selctFrequency.click();
		Select freq=new Select(selctFrequency);
		freq.selectByValue("Daily");
		frequncyShedule.sendKeys("1");
	...
	public void assignPerson() {
		...
		selectPerson.click();
		sendPersonNumber.sendKeys("ANVESH SHRIKHANDE");
	...
	public void addWorkFlow() throws InterruptedException {
		...
		enterWorkFlowName.sendKeys("Anwesh");
		selectTrigger.click();
		...
		action.moveToElement(emailUseranvwesh).click().perform();
		notificationUser.click();
		action.moveToElement(notificationKilas).click().perform();
		action.moveToElement(notificationanwesh).click().perform();
		action.moveToElement(notificatioMayur).click().perform();
		saveButton.click();
